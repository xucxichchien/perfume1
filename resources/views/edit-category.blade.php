        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" action="{{url('update-category')}}">
                    @csrf
                    <input type="hidden" name="categoryID" value="{{$datacate->categoryID}}">
                    <div class="md-3">
                        <label class="form-label">Name</label>
                        <input type="text" class="form-control" name="categoryName" placeholder="Enter brand name" value="{{$datacate->categoryName}}">
                        @error('categoryName')
                    ...
                    <div class="md-3">
                        ...
                        <input type="file" class="form-control" name="categoryImage" value="{{$datacate->categoryImage}}">
                        @error('categoryImage')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
