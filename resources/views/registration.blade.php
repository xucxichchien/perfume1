            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light shadow p-lg-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <a href="index.html" class="navbar-brand mx-5 d-none d-lg-block">
                        <h1 class="m-0 display-4 text-secondary"><span class="text-secondary">i</span>Ris</h1>
                    </a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" >
                <h4 class="text-white text-uppercase mb-md-3">Registration</h4>
                ...
                <form action="{{url('register-user')}}" method="post" class = "mb-md-4">
                    ...
                    <br>
                    <a class="btn btn-block btn-secondary" href="login">Alredy Register !! login here</a>
                </form>
            </div>
        </div>
    </div>
