            ...
            <div class="col-md-12">
                ...
                <form method="post" action="{{url('update-admin')}}">
                    ...
                    <div class="md-3">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Enter product name" value="{{$dataadmin->name}}">
                        @error('name')
                    ...
                    <div class="md-3">
                        ...
                        <input type="text" class="form-control" name="email" placeholder="Enter product price" value="{{$dataadmin->email}}">
                        @error('email')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
