        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div style="float: right">
                    ...
                    <a href="{{url('add-admin')}}" class="btn btn-primary">Add Admin</a>
                </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $prod)
                            <tr>
                                ...
                                <td>{{$prod->prodDes}}</td>
                                @foreach($databrand as $pro)
                                @if($pro->brandID===$prod->brandID)
                                <td>{{$pro->brandName}}</td>
                                @endif
                                @endforeach
                                
                                    @foreach($datacate as $prod1)
                                    @if($prod->categoryID===$prod1->categoryID)
                                    <td>{{$prod1->categoryName}}</td>
                                    @endif
                                    @endforeach
                                <td><img src= "images/{{$prod->prodImage}}" width="100px" height="100px"></td>
                                <td><a href="{{url('edit-product/'.$prod->id)}}" class="btn btn-primary">Edit</a> </td>
                                <td><a href="{{url('delete-product/'.$prod->id)}}" class="btn btn-danger">Delete</a></td>
                            </tr>
                        @endforeach
                    </tbody>              
                  </table>
