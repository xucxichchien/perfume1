                    ...
                    <tbody>
                        ...
                        @foreach ($databrand as $brand)
                            <tr>
                                ...
                                <td><img src= "images/{{$brand->brandImage}}" width="100px" height="100px"></td>
                                <td><a href="{{url('edit-brand/'.$brand->brandID)}}" class="btn btn-primary">Edit</a> | <a href="{{url('delete-brand/'.$brand->brandID)}}" class="btn btn-danger">Delete</a></td>
                            </tr>
                        @endforeach
                    </tbody>              
                  </table>
