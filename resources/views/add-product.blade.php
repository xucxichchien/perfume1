            ...
            <div class="col-md-12">
                ...
                <form method="post" action="{{url('save-product')}}">
                    ...
                    <div class="md-3">
                        ...
                        <input type="text" class="form-control" name="prodName" placeholder="Enter product name" value="{{old('prodName')}}">
                        @error('prodName')
                    ...
                    <div class="md-3">
                        ...
                        <input type="text" class="form-control" name="prodPrice" placeholder="Enter product price" value="{{old('prodPrice')}}">
                        @error('prodPrice')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
                    ...
                    <div class="md-3">
                        ...
                        <input type='textarea' class="form-control" name="prodDes" value="{{old('prodDes')}}">
                        @error('prodDes')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
                    ...
                    <div class="md-3">
                        ...
                        <input type="file" class="form-control" name="prodImage" value="{{old('prodImage')}}">
                        @error('prodImage')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
