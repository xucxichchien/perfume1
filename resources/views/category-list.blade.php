                    ...
                    <tbody>
                        ...
                        @foreach ($datacate as $category)
                            <tr>
                                ...
                                <td><img src= "images/{{$category->categoryImage}}" width="100px" height="100px"></td>
                                <td><a href="{{url('edit-category/'.$category->categoryID)}}" class="btn btn-primary">Edit</a> | <a href="{{url('delete-category/'.$category->categoryID)}}" class="btn btn-danger">Delete</a></td>
                            </tr>
                        @endforeach
                    </tbody>              
                  </table>
