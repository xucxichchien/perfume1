    ...
    <div class="container" style='margin-top:20px'>
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <form method="post" action="{{url('save-brand')}}">
                    @csrf
                    <div class="md-3">
                        <label class="form-label">Brand name</label>
                        <input type="text" class="form-control" name="brandName" placeholder="Enter brand name" value="{{old('brandName')}}">
                        @error('brandName')
                    ...
                    <div class="md-3">
                        ...
                        <input type="file" class="form-control" name="brandImage" value="{{old('brandImage')}}">
                        @error('brandImage')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
