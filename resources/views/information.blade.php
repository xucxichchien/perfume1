    ...
    <div class="container" style='margin-top:20px'>
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" action="{{route('save-information')}}">
                    @csrf
                    <div class="md-3">
                        <label class="form-label">ID</label>
                        <input type="text" class="form-control" name="id" placeholder="Enter product name" value="{{$user->id}}" readonly>
                        @error('id')
                    ...
                    <div class="md-3">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Enter product price" value="{{$user->name}}">
                        @error('name')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
                    ...
                    <a href="{{url('index.html')}}" class="btn btn-danger">Back</a>
                </form>
            </div>
        </div>
    </div>
