        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" action="{{url('update-brand')}}">
                    @csrf
                    <input type="hidden" name="brandID" value="{{$databrand->brandID}}">
                    <div class="md-3">
                        <label class="form-label">Name</label>
                        <input type="text" class="form-control" name="brandName" placeholder="Enter brand name" value="{{$databrand->brandName}}">
                        @error('brandName')
                    ...
                    <div class="md-3">
                        ...
                        <input type="file" class="form-control" name="brandImage" value="{{$databrand->brandImage}}">
                        @error('brandImage')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
                    ...
                    <a href="{{url('brand-list')}}" class="btn btn-danger">Back</a>
                </form>
            </div>
        </div>
    </div>
